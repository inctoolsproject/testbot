...
#vidia
kt = LINETCR.LINE()
kt.login(token="Enbq2C3NSwY4kURxba71.HKv/sRH3APMSBJYQ5gS8Gq.gJrW0g3xCcobj5XLFEMINJgDlSwBWxKrWgL5qKlXqYU=")
kt.loginResult()
#rosetta
ks = LINETCR.LINE()
ks.login(token="EnDB8XqRTOEdC3noez42.0rCUk7foerc8IrT9stPTSG.cZ2c2rYxFxGR43eU0C9FfEy0c2HcplG5ztJuRQvor6I")
ks.loginResult()
#sirvelmist
ki = LINETCR.LINE()
