...
kk.login(token="EnDB8XqRTOEdC3noez42.0rCUk7foerc8IrT9stPTSG.cZ2c2rYxFxGR43eU0C9FfEy0c2HcplG5ztJuRQvor6I=")
kk.loginResult()

kc = LINETCR.LINE() #Ussop
kc.login(token="EnvoFeuViKHbigdWmnoc.DU6xYokC/xQjZ1biq0d1da.hh9RqMvRLGKiFwyNQpDs6Ir6SkqyUhqnJ8vJ94naPpU=")
kc.loginResult()

ks = LINETCR.LINE() #Chooper
ks.login(token="EnXUoUvAqAMraukIAMMa.PFXzqQLJ+9VQr1tO0qoqgG.FJ1iIK7xhtEircLZqy42XWHFDj4QYn0F1Z6okOOWOyU=")
ks.loginResult()
...
#--------===---====--------------
              ...
              if msg.from_ in admin:
                ...
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"กำลังแปล2")
                    else:
                        cl.sendText(msg.to,"กำล้งแปล2")
                ...
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"กำลังหัดแปล1")
                    else:
                        cl.sendText(msg.to,"กำลังหัดแปล1")
...
#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
            elif msg.text in ["หำมา","One piece","Join kuy"]: #Panggil Semua Bot
              if msg.from_ in owner:
    ...
    #-------------Fungsi Tag All Finish---------------#
      ...
      #--------------List Group------------
       #------------ Keluar Dari Semua Group------
            elif msg.text in ["บายหำ","บาย"]: # Keluar Dari Semua Group Yang Di dalem nya  ada bot(Kalo Bot Kalian Nyangkut di Group lain :D)
              if msg.from_ in owner:
                gid = cl.getGroupIdsJoined()
...
#-----------------------------------------------
      ...
      #-------------Fungsi Balesan Respon Finish---------------------#
       ...
       #-------------Fungsi Speedbot Start---------------------#
              ...
              if msg.from_ in admin:
                start = time.time()
                cl.sendText(msg.to, "รอแป๊พบักหำ By.มิน...")
                elapsed_time = time.time() - start
                cl.sendText(msg.to, "อะได้แล้วช้าไปนะ" % (elapsed_time))
      ...
      #-------------Fungsi Banned Send Contact Finish------------------#
              ...
              cl.sendMessage(msg)
              cl.sendText(msg.to,"======================")
              cl.sendText(msg.to,"My Min Hack BOT😜")
                
      #-------------Fungsi Chat ----------------
            elif msg.text in ["Woy","woy","Woi","woi","bot","Bot"]:
                 quote = ['ค่อยแปลที่หลังละกันยังไม่รุ้คำสั่ง?']
